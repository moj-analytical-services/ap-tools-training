...
- Set up a [GitHub account with two-factor authentication](https://user-guidance.analytical-platform.service.justice.gov.uk/get-started.html#1-github-account).   
- Set up a [Analytical Platform account](https://user-guidance.analytical-platform.service.justice.gov.uk/get-started.html#3-analytical-platform-account).  

Once you have completed the above two steps, you should be able to access the [Analytical Platform Control Panel](https://controlpanel.services.analytical-platform.service.justice.gov.uk/tools/) and from there open the relevant tool (e.g. RStudio for R). 

Third, as code written on the Analytical Platform should be stored in a Git repository on GitHub, complete the steps [to configure Git and GitHub for the Analytical Platform](https://user-guidance.analytical-platform.service.justice.gov.uk/github/set-up-github.html#set-up-github). You can learn more about GitHub by viewing [this introduction](https://digital.gov/resources/an-introduction-github/) and by attending [the internal introduction to GitHub](https://moj-analytical-services.github.io/ap-tools-training/ITG.html#github-training).
