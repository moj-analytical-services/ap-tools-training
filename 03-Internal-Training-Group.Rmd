...
The recordings of these R training sessions are available in [the R/SQL/Git Training Video Playlist](https://justiceuk.sharepoint.com/:l:/s/RTrainingGroup/FHj_mP5zSBtDkdrR7YL88wUB0tRT5Jt1qz09LMu4pmlU8A?e=Cdb21d).

## Git/GitHub Training

Whether seeking to use R, SQL or Python, it is recommended that all newcomers attend or work through themselves this [Introduction to Git/GitHub](https://github.com/moj-analytical-services/intro_to_github_training) (click on link to view material in GitHub repository) session. A recording can be viewed in [the R/SQL/Git Training Video Playlist](https://justiceuk.sharepoint.com/:l:/s/RTrainingGroup/FHj_mP5zSBtDkdrR7YL88wUB0tRT5Jt1qz09LMu4pmlU8A?e=Cdb21d).	

## SQL Training

All newcomers who are to use SQL should attend or work through themselves the [Introduction to SQL](https://github.com/moj-analytical-services/sql_training) (click on link to view material in GitHub repository) session. A recording of this session is available in [the R/SQL/Git Training Video Playlist](https://justiceuk.sharepoint.com/:l:/s/RTrainingGroup/FHj_mP5zSBtDkdrR7YL88wUB0tRT5Jt1qz09LMu4pmlU8A?e=Cdb21d).
